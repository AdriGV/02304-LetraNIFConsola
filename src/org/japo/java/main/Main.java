...
//            el 0 del char at es para coger la primera letra 
//            En printf, ponemos %C para que salga mayuscula
        } catch (Exception e) {

            System.out.println("ERROR: Entrada incorrecta.");

        } 
//        No se pone el finally pq no hat que vacia buffer, al ser caracter
    }
}
